"""fuego_cubano_19354 URL Configuration
...
admin.site.site_header = "Fuego Cubano"
admin.site.site_title = "Fuego Cubano Admin Portal"
admin.site.index_title = "Fuego Cubano Admin"

# swagger
api_info = openapi.Info(
    title="Fuego Cubano API",
    default_version="v1",
    description="API documentation for Fuego Cubano App",
)
